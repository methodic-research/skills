...
description: |
  ...
  collection — "make a collection for structural loads", "add these papers to the
  structural-loads collection", "group these experiments under hydrodynamics",
  "associate this experiment with the hydrodynamics collection", "search only within
  the hydrodynamics collection". A collection is a named, ACL'd topic grouping that
